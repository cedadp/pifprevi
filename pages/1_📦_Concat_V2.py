...
#uploaded_file = "C:/Users/demanet/Downloads/Prévisions d'activité Sem 30-38 du 22.07.2024.xlsx" # utilisé pour débogage en local
#uploaded_file2 = "C:/Users/demanet/Downloads/Prévis_PIF_J-7_2024-07-23.xlsx" # utilisé pour débogage en local
...
if uploaded_file is not None and download is False:
    ...
    if uploaded_file2 is not None:
        ...
        df_pgrm_concat.loc[(df_pgrm_concat['Cie Ope'].isin(sat6)) & (df_pgrm_concat['Libellé terminal'] == 'Terminal 1') , 'Libellé terminal'] = 'Terminal 1_6'
        df_pgrm_concat.loc[(df_pgrm_concat['Cie Ope'].isin(sat5)) & (df_pgrm_concat['Libellé terminal'] == 'Terminal 1') , 'Libellé terminal'] = 'Terminal 1_5'
