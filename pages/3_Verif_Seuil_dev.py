...
# calcul du cumul de charge horaire glissant à partir de données 10 min
    ...
    # retourne le dataframe dans un format "long"
        ...
        st.download_button( label="⬇️ Télécharger les données (Excel)", data=to_excel_bytes(df_depivote, sheet_name="Data"), file_name="data.xlsx", mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", )
